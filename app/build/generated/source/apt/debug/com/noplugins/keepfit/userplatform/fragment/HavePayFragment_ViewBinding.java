...
public class HavePayFragment_ViewBinding implements Unbinder {
  private HavePayFragment target;

  @UiThread
  public HavePayFragment_ViewBinding(HavePayFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    HavePayFragment target = this.target;
