...
public class CollectionChangguanFragment_ViewBinding implements Unbinder {
  private CollectionChangguanFragment target;

  @UiThread
  public CollectionChangguanFragment_ViewBinding(CollectionChangguanFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    CollectionChangguanFragment target = this.target;
