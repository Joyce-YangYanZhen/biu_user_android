...
public class CollectionSijiaoFragment_ViewBinding implements Unbinder {
  private CollectionSijiaoFragment target;

  @UiThread
  public CollectionSijiaoFragment_ViewBinding(CollectionSijiaoFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    CollectionSijiaoFragment target = this.target;
