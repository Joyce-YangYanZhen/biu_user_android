...
public class PlatFormAdapter extends BaseRecyclerAdapter<RecyclerView.ViewHolder> {
    ...
    public PlatFormAdapter(List<MessageDateEntity.ListBean> mlist, Activity mcontext) {
        list = mlist;
        context = mcontext;
    }
    ...
    private RecyclerView.ViewHolder getViewHolderByViewType(int viewType, ViewGroup parent) {
        ...
        if (viewType == EMPTY_VIEW) {
            ...
            item_view = LayoutInflater.from(context).inflate(R.layout.platform_message_item, parent, false);
