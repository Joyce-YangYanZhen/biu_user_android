...
package com.noplugins.keepfit.userplatform.util.ui.erweima.camera;
...
import com.noplugins.keepfit.userplatform.util.ui.erweima.android.CaptureActivityHandler;
...
//    }
    ...
    public PlanarYUVLuminanceSource buildLuminanceSource(byte[] data,
        ...
        if (config.isFullScreenScan()) {
            ...
            int actionbarHeight = context.getResources().getDimensionPixelSize(R.dimen.m80);
