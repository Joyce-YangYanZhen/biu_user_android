...
public class ThumbImageView extends ImageButton {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (text!=null){
            canvas.drawText(text, mWidth/2, 50+(mHeight-50)/2, paint);
        }
    }
